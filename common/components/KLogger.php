	...
	*/
	...
	class KLogger
	{
		...
		public function __construct( $filepath , $priority )
		{
			...
			$path = Yii::getPathOfAlias("application.runtime").DS.$filepath.".log";
			if(file_exists($path) && filesize($path) > 10*1024*1024){
				rename($path,Yii::getPathOfAlias("application.runtime").DS.$filepath."_".date('YmdHis').".log");
			}
		...
		public function LogInfo($line, $show = true)
		{
